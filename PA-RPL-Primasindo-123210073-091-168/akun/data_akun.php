            ...
            <div class="col-md-12">
                <div class="row mt-4">
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title"><img src="../gambar/riwayat-icon.png" alt="Logo-Profil" width="30" height="24" class="d-inline-block align-text-top">Master Data Akun</h5>
                                <hr>
                                    ...
                                    ?>
                                        <tbody class="table-group-divider">
                                            <tr>
                                                ...
                                                <td><?= $data['no_telp'] ?></td>
                                                <td><?= $data['level'] ?></td>
                                                <td><a href="detail_data_akun.php?id_user=<?= $data['id_user'] ?>" class="btn btn-success" style="font-size: small;">Lihat Detail</a></td>
                                            </tr>
                                        </tbody>
                                    <?php $i++;
                                    } ?>
