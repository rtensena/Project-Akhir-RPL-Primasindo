            ...
            <div class="collapse navbar-collapse" id="navbarText">
                ...
                <ul class="navbar-nav">
                    ...
                    ?>
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="../akun/data_akun.php">Data Akun</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="row">
            ...
            <div class="col-6">
                <div class="row text-dark mt-4">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title"><img src="../gambar/profil-icon.png" alt="Logo-Profil" width="30" height="24" class="d-inline-block align-text-top"> Detail Data Akun</h5>
                            <hr>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <a href="hapus_akun.php?id_user=<?= $data['id_user'] ?>" class="btn btn-danger d-block text-light">Hapus Profil</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <form role="form" action="edit_akun_proses.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingInput" value="<?= $data['username'] ?>" name="username" required="">
                        ...
                        <div class="form-floating mb-3">
                            <input type="email" class="form-control" id="floatingInput" value="<?= $data['email'] ?>" name="email" required="">
                        ...
                        <div class="form-floating mb-3">
                            <input type="date" class="form-control" id="floatingInput" value="<?= $data['tanggal_lahir'] ?>" name="tanggal_lahir" required="">
                            <label for="floatingInput">Tanggal Lahir</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingInput" value="<?= $data['umur'] ?>" name="umur" required="">
                            <label for="floatingInput">Umur</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingInput" value="<?= $data['pekerjaan'] ?>" name="pekerjaan" required="">
                            <label for="floatingInput">Pekerjaan</label>
                        </div>
                        <div class="form-floating" style="margin: 17px 0px">
                            <select class="form-select" id="floatingSelect" aria-label="Floating label select example" value="<?= $data['jenis_kelamin'] ?>" name="jenis_kelamin" required>
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingInput" value="<?= $data['alamat'] ?>" name="alamat" required="">
