...
<body>
    ...
    <div class="container text-dark">
        <div class="row">
            <div class="col-5">
                <img src="../gambar/detail-riwayat-img.png" alt="" width="350" class="ms-5 mt-5">
            </div>
            <div class="col-7">
                <div class="row text-dark mt-4 mb-4">
                    <div class="col-sm-12 g-4">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title"><img src="../gambar/detail-riwayat-icon.png" alt="Logo-Profil" width="30" height="24" class="d-inline-block align-text-top"> Detail Data Konsultasi Anda</h5>
                                <hr>
                                <form action="" method="POST">
                                    ...
                                    ?>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" readonly class="form-control-plaintext" id="status" value="<?= $data['status'] ?>">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                        ...
                                        <div class="mb-3 row">
                                            <label for="psikolog" class="col-sm-3 col-form-label">Nama Psikolog</label>
                                            <div class="col-sm-9">
                                                <input type="text" readonly class="form-control-plaintext" id="psikolog" value="<?= $data['nama_psikolog'] ?>">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            <label for="id_praktek" class="col-sm-3 col-form-label">Waktu Konsultasi</label>
                                            <div class="col-sm-9">
                                                <input type="text" readonly class="form-control-plaintext" id="id_praktek" value="<?= $data['hari'] ?> / <?= $data['tanggal'] ?> / <?= $data['jam'] ?>">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            <label for="tanggal_daftar" class="col-sm-3 col-form-label">Tanggal Daftar</label>
                                            <div class="col-sm-9">
                                                <input type="text" readonly class="form-control-plaintext" id="tanggal_daftar" value="<?= $data['tanggal_daftar'] ?>">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            <label for="keluhan" class="col-sm-3 col-form-label">Keluhan</label>
                                            <div class="col-sm-9">
                                                <input type="text" readonly class="form-control-plaintext" id="keluhan" value="<?= $data['keluhan'] ?>">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            <label for="diagnosa" class="col-sm-3 col-form-label">Diagnosa</label>
                                            <div class="col-sm-9">
                                                <input type="text" readonly class="form-control-plaintext" id="diagnosa" value="<?= $data['diagnosa'] ?>">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            <label for="tanggal_kontrol" class="col-sm-3 col-form-label">Tanggal Kontrol</label>
                                            <div class="col-sm-9">
                                                <input type="date" readonly class="form-control-plaintext" id="tanggal_kontrol" value="<?= $data['tanggal_kontrol'] ?>">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            <label for="biaya_total" class="col-sm-3 col-form-label">Biaya Total</label>
                                            <div class="col-sm-9">
                                                <input type="text" readonly class="form-control-plaintext" id="biaya_total" value="<?= $data['biaya_total'] ?>">
                                            </div>
                                        </div>
                                        <?php
                                        if ($_SESSION['level'] == "client") {
                                        ?>
                                            <a class="btn btn-danger d-block text-light" data-bs-toggle="modal" data-bs-target="#hapus">Hapus Riwayat</a>
                                        <?php
                                        } else {
                                        ?>
                                            <div class="mb-3 row">
                                                <div class="col-6">
                                                    <a class="btn btn-success d-block text-light" href="edit_riwayat.php?id_konsul=<?= $data['id_konsul'] ?>">Update Riwayat</a>
                                                </div>
                                                <div class="col-6">
                                                    <a class="btn btn-danger d-block text-light" data-bs-toggle="modal" data-bs-target="#hapus">Hapus Riwayat</a>
                                                </div>
                                        ...
                                        <div class="modal fade" id="hapus" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        Data riwayat yang sudah dihapus tidak dapat dikembalikan
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                                        <a href="hapus_riwayat.php?id_konsul=<?= $data['id_konsul'] ?>" type="button" class="btn btn-primary">Hapus</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <form role="form" action="edit_akun_proses.php" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="form-floating mb-3">
                                                                <input type="text" class="form-control" id="floatingInput" value="<?= $data['nama_lengkap'] ?>" name="nama_lengkap" required="">
                                                                <label for="floatingInput">Nama Pasien</label>
                                                            </div>
                                                            <div class="form-floating mb-3">
                                                                <input type="text" class="form-control" id="floatingInput" value="<?= $data['no_telp'] ?>" name="no_telp" required="">
                                                                <label for="floatingInput">Nomor Telepon</label>
                                                            </div>
                                                            <div class="form-floating mb-3">
                                                                <select class="form-select" name="id_psikolog" id="id_psikolog" onchange="kota()" aria-label="Floating label select example" value="" required>
                                                                    <option value=""></option>
                                                                    <?php
                                                                    include 'koneksi.php';
                                                                ...
                                                                <label for="id_psikolog">Nama Psikolog</label>
                                                            </div>
                                                            <div class="form-floating mb-3">
                                                                ...
                                                                <script>
                                                                    function kota() {
                                                                        var id_psikolog = $('#id_psikolog').val();
                                                                        $('#jadwal').load("../jadwal.php?id=" + id_psikolog + "");
                                                                    }
                                                                </script>
                                                                <label for="jadwal">Waktu Konsultasi</label>
                                                            </div>
                                                            <div class="form-floating mb-3">
                                                                <textarea style="resize:none;height:150px;" class="form-control" placeholder="Keluhan" id="floatingTextarea" name="keluhan" value="<?= $data['keluhan'] ?>" required=""></textarea>
                                                                <label for="floatingTextarea">Keluhan</label>
                                                            </div>
                                                            <div class="form-floating mb-3">
                                                                <textarea style="resize:none;height:150px;" class="form-control" placeholder="Diagnosa" id="floatingTextarea" name="diagnosa" value="<?= $data['diagnosa'] ?>" required=""></textarea>
