...
<body>
    ...
    <div class="container text-dark" style="font-size: small;">
        <div class="row">
            <div class="col-md-12">
                <div class="row mt-4">
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title"><img src="../gambar/riwayat-icon.png" alt="Logo-Profil" width="30" height="24" class="d-inline-block align-text-top">Riwayat Pendaftaran Konsultasi</h5>
                                <hr>
                                <?php
                                if ($_SESSION['level'] == "client") {
                                ?>
                                    <table class="table table-hover">
                                        ...
                                        $sql = "SELECT * FROM jadwal_konsul INNER JOIN user ON jadwal_konsul.id_user = user.id_user INNER JOIN psikolog ON jadwal_konsul.id_psikolog = psikolog.id_psikolog INNER JOIN jadwal_praktek ON jadwal_konsul.id_praktek = jadwal_praktek.id_praktek WHERE jadwal_konsul.id_user=$id_user";
                                        $query = mysqli_query($connect, $sql);
                                        $i = 1;
                                        ...
                                        ?>
                                            <tbody class="table-group-divider">
                                                <tr>
                                                    ...
                                                    <td><?= $data['hari'] ?> / <?= $data['tanggal'] ?> / <?= $data['jam'] ?></td>
                                                    <td><?= $data['tanggal_daftar'] ?></td>
                                                    <td><?= $data['keluhan'] ?></td>
                                                    <td><?= $data['diagnosa'] ?></td>
                                                    <td><?= $data['tanggal_kontrol'] ?></td>
                                                    <td><?= $data['biaya_total'] ?></td>
                                                    <td><?= $data['status'] ?></td>
                                                    <td><a href="detail_riwayat.php?id_konsul=<?= $data['id_konsul'] ?>" class="btn btn-success" style="font-size: small;">Lihat Detail</a></td>
                                                </tr>
                                            </tbody>
                                        <?php $i++;
                                        } ?>
                                ...
                                ?>
                                    <table class="table table-hover">
                                        ...
                                        $sql = "SELECT * FROM jadwal_konsul INNER JOIN user ON jadwal_konsul.id_user = user.id_user INNER JOIN psikolog ON jadwal_konsul.id_psikolog = psikolog.id_psikolog INNER JOIN jadwal_praktek ON jadwal_konsul.id_praktek = jadwal_praktek.id_praktek";
                                        $query = mysqli_query($connect, $sql);
                                        $i = 1;
                                        while ($data = mysqli_fetch_array($query)) {
                                        ?>
                                ...
                                <?php    } elseif ($_SESSION['level'] == "psikolog") {
                                ?>
                                    <table class="table table-hover">
                                        <thead>
                                            <tr>
                                        ...
                                        $sql = "SELECT * FROM jadwal_konsul INNER JOIN user ON jadwal_konsul.id_user = user.id_user INNER JOIN psikolog ON jadwal_konsul.id_psikolog = psikolog.id_psikolog INNER JOIN jadwal_praktek ON jadwal_konsul.id_praktek = jadwal_praktek.id_praktek WHERE psikolog.nama_psikolog = '$nama'";
                                        $query = mysqli_query($connect, $sql);
                                        $i = 1;
                                        while ($data = mysqli_fetch_array($query)) {
                                        ?>
